...
- (GlkStyle *)clone {
    ...
    NSParagraphStyle *paragraphStyle = [[dict objectForKey:NSParagraphStyleAttributeName] copy];
...
- (NSSize)cellSize {
    ...
    size.height = [layoutManager defaultLineHeightForFont:font] + self.lineSpacing;
    return size;
}
...
-(void)createDefaultAttributeDictionary {
    ...
    [dict setObject:@(self.index) forKey:@"GlkStyle"];
...
- (NSFont *)font {
    return [self.attributeDict objectForKey:NSFontAttributeName];
}

- (void)setFont:(NSFont *)font {
    NSMutableDictionary *mutableDict = [self.attributeDict mutableCopy];
    [mutableDict setObject:font forKey:NSFontAttributeName];
    self.attributeDict = mutableDict;
}


- (NSColor *)color {
    return [self.attributeDict objectForKey:NSForegroundColorAttributeName];
}

- (void)setColor:(NSColor *)color {
    NSMutableDictionary *mutableDict = [self.attributeDict mutableCopy];
    [mutableDict setObject:color forKey:NSForegroundColorAttributeName];
    self.attributeDict = mutableDict;
}
...
- (void)setIndex:(NSInteger)i {
    NSMutableDictionary *dict = [self.attributeDict mutableCopy];
    [dict setObject:@(i) forKey:@"GlkStyle"];
    self.attributeDict = dict;
}

- (CGFloat)lineSpacing {
    return [[self.attributeDict objectForKey:NSParagraphStyleAttributeName] lineSpacing];
}

- (void)setLineSpacing:(CGFloat)lineSpacing {
    NSMutableDictionary *dict = [self.attributeDict mutableCopy];
    NSMutableParagraphStyle *paraStyle = [[dict objectForKey:NSParagraphStyleAttributeName] mutableCopy];
    if (!paraStyle) {
