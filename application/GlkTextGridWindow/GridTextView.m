...
- (void)mouseDown:(NSEvent *)theEvent {
    if (![(GlkTextGridWindow *)self.delegate myMouseDown:theEvent] || ((GlkTextGridWindow *)self.delegate).glkctl.gameID == kGameIsBeyondZork || ((GlkTextGridWindow *)self.delegate).glkctl.zVersion6)
