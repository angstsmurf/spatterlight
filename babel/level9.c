...
struct l9patchrec
{
    int32 length;			/* datafile length, bytes */
    unsigned char origchk;              /* 8-bit checksum, last datafile byte */
    unsigned char patchchk;             /* 8-bit checksum, last datafile byte */    
};

static struct l9patchrec l9_patch_registry[] = {
    {0x7410, 0x5e, 0x70},
    {0x6fc6, 0x14, 0x26},
    {0x5aa4, 0xc1, 0xd3},
    {0x5aa4, 0xc1, 0xc1},
