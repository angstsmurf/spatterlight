...
static gidispatch_intconst_t intconstant_table[] = {
    ...
    { "mapevent_UserHide", (2) },
    { "mapflag_HasFocus", (0x00000001) },
    { "mapflag_None", (0x00000000) },
    { "mapflag_SuggestShow", (0x00000002) },
    { "mapflag_UserRequestedShow", (0x00000004) },
    { "mapimage_JPEG", (3) },
    { "mapimage_PNG", (2) },
    { "mapimage_SVG", (1) },
...
static gidispatch_function_t function_table[] = {
    ...
    /* Map document extension (gestalt_Map) */
    { 0x1203, glk_map_present, "map_present" },
...
void gidispatch_call(glui32 funcnum, glui32 numargs, gluniversal_t *arglist)
{
    switch (funcnum) {
        ...
        case 0x1203: /* map_present */
            /* Hyperlink struct array is C-only; dispatch presents with none.
               [0]=format [1]=ptrflag [2]=array [3]=len [4]=flags [5]=bgcolor
               [6..9]=focus [10]=return  (or shorter if null array). */
            if (arglist[1].ptrflag)
                arglist[10].uint = glk_map_present(arglist[0].uint, arglist[2].array,
                    arglist[3].uint, arglist[4].uint, arglist[5].uint,
                    arglist[6].sint, arglist[7].sint,
                    arglist[8].uint, arglist[9].uint, NULL, 0);
            else
                arglist[8].uint = glk_map_present(arglist[0].uint, NULL, 0,
        ...
        case 0x120A: /* map_set_hyperlinks */
            ...
            break;
        case 0x120B: /* map_overlay */
            /* [0..6] scalars, [7] ptrflag, [8] array, [9] len, [10] return */
            {
