...
/* Update window background immediately (text buffer, text grid, graphics).
   ...
   limited to graphics windows. For text windows it also sets the Normal
   BackColor stylehint and live-updates existing Normal-styled text (and the
   pane/border). Color 0xffffffff (zcolor_Default) restores the interpreter
   default and clears the Normal BackColor hint. */
