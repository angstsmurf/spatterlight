/***************************************************************************
 *  Bundled built-in copy of "MaDbRiT's Type Library" (typelib.qlb), the
 *  standard Quest 4 type library by Al Bampton (MaDbRiT), v1.009 06-Sep-2003.
 *
 *  The .qlb shipped with Quest/QDK, not with games, so a game that
...
#define GEAS_TYPELIB_BUILTIN_HH

static const char geas_builtin_typelib[] = R"GEASLIB(
!library
!deprecated
!asl-version <311>
