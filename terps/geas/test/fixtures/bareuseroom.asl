...
!
! This fixture is the ASL 350 half; bareuseroom410.asl is the same source at 410.
define game <bareuseroom>
    asl-version <350>
    start <r1>
end define
...
define room <r1>
    ...
    define object <torch>
        look msg <A torch.>
        take
        ! The item's own handler, which the room's shadows below 410.
