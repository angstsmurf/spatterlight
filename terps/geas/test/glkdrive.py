...
(NOREPLY, OKAY, ERROR, HELLO, PROMPTOPEN, PROMPTSAVE, NEWWIN, DELWIN, SIZWIN,
 ...
 MENUITEM,
 MAPPRESENT, MAPCLOSE, MAPFOCUS, MAPCLEARFOCUS, INITMAPEVENT, CANCELMAPEVENT,
 MAPPRESENTIMAGE, MAPOVERLAY, MAPOVERLAYMOVE, MAPOVERLAYCLEAR, MAPOVERLAYCLEARALL,
 MAPSETHYPERLINKS,
 NEXTEVENT, EVTARRANGE, EVTREDRAW, EVTLINE, EVTKEY, EVTMOUSE,
 EVTTIMER, EVTHYPER, EVTSOUND, EVTVOLUME, EVTPREFS, EVTQUIT,
 EVTTEST, EVTMAP) = range(85)
