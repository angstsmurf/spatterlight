...
A COMMAND of the form "link:N" clicks hyperlink value N instead of sending a
line -- the only way to reach the Quest 5 frontend's link handling, since
CheapGlk (the other harnesses) reports no hyperlink support at all.  Ending
the script while a prompt is up sends EVTQUIT, the autosave-preserving
...
(NOREPLY, OKAY, ERROR, HELLO, PROMPTOPEN, PROMPTSAVE, NEWWIN, DELWIN, SIZWIN,
 ...
 CANCELLINK, SETZCOLOR, SETREVERSE, CSSHINT, CLEARCSSHINT, CLEARALLCSSHINT,
 SETCSSINLINE, CLEARCSSINLINE, CSSSELECTORHINT, CLEARCSSSELECTORHINT,
 CLEARALLCSSHINTBYSELECTOR, CLEARALLCSSHINTBYWINDOW, CLEARALLCSSINLINE,
 QUOTEBOX, SHOWERROR, CANPRINT, PURGEIMG,
