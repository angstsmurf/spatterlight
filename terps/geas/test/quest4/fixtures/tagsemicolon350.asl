...
'
' This is the version above both gates: everything but `take' is cut.
' tagsemicolon.asl is below both and tagsemicolon320.asl between them, on the
' same tags.
define game <tagsemicolon350>
    asl-version <350>
    start <Yard>
end define
