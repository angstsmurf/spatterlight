...
'
' This is the version below both gates: nothing here is cut.
' tagsemicolon320.asl is between them -- the object's tags are cut, the room's
' are not -- and tagsemicolon350.asl above both.
define game <tagsemicolon>
    asl-version <300>
    start <Yard>
end define
