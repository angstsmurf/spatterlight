...
Build:
    python3 make_400_battlemultiprobe.py p4BATTLEMULTI2.plain
    python3 taftool.py pack p4BATTLEMULTI2.plain p4TAKE.taf p4BATTLEMULTI2.taf
"""
import sys
...
npc("Robot", [], "A robot.", "A robot clanks about.")
...
body = ("\r\n".join(L) + "\r\n").encode("latin-1")
out = sys.argv[1] if len(sys.argv) > 1 else "p4BATTLEMULTI2.plain"
