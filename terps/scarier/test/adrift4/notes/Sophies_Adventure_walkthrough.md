...
|---|---|---|---|---|
| `sa.taf` (later, `040104`) | 536710 | `goldens/sophie_solution.txt` | 255 | ★ **WON**, **193** points, ending 3 of 5 |
| `sophie.taf` (IFComp release) | 531015 | `goldens/sophie_comp_solution.txt` | 255 | ★ **WON**, **183** points, ending 3 of 5 |
...
- **Solution:** `goldens/sophie_comp_solution.txt`, 255 commands.
