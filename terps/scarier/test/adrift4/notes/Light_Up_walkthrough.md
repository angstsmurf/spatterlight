...
75.** Solution `goldens/light_up_solution.txt`. Reproduce with
`sh harness/play.sh games/light_up_4summer_comp.taf goldens/light_up_solution.txt`
...
The banked `goldens/light_up_solution.txt` scores **73**: every story point and
