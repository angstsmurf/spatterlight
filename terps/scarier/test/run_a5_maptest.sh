...
# test/a5probes/src/map.xml (spec: ADRIFT-5-XML.md section 6.15).  Renders a
# fixed set of views with test/a5map_dump and compares each PPM's sha256
# against the committed manifest test/a5probes/map_golden.sha256.
#
# usage: test/run_a5_maptest.sh [-b]
...
BIN="$HERE/test/a5map_dump"
TAF="$HERE/test/a5probes/map.taf"
MANIFEST="$HERE/test/a5probes/map_golden.sha256"
OUT=/tmp/a5maptest
