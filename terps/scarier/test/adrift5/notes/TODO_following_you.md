...
- Barry is a character with `CharacterLocation = "On Character"`,
  ...
  (dump: `A5_DUMP_XML=1 ./test/adrift5/harness/a5run_dump test/adrift5/games/symphonica.blorb /dev/null`,
...
2. Re-dump to confirm Barry now resolves to the player's room and the line
   ...
   `./test/adrift5/harness/a5run_dump test/adrift5/games/symphonica.blorb test/adrift5/goldens/Symphonica64_walkthrough.txt | grep -c 'Barry Leitch is following you'`
   (expect ~1956, matching FD).
3. `FD_RNG=xoshiro ./test/adrift5/harness/a5_groundtruth.sh symphonica.blorb test/adrift5/goldens/Symphonica64_walkthrough.txt`
...
5. `./test/adrift5/harness/run_a5_walkthroughs.sh` — **whole suite**, not just Symphonica: this
