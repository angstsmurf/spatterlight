...
suite (`./test/adrift5/harness/run_a5_walkthroughs.sh`) with **zero** previously-MATCH game
...
```
cd terps/scarier
A5_RNG=xoshiro A5_TRACE_RAND=1 ./test/adrift5/harness/a5run_dump test/adrift5/games/symphonica.blorb \
    test/adrift5/goldens/Symphonica64_walkthrough.txt >/tmp/scar.txt 2>/tmp/scar_rand.txt
DOTNET_ROLL_FORWARD=Major FD_RNG=xoshiro FD_RNG_TRACE=1 FD_SEED=1234 \
    ...
    "$PWD/test/adrift5/goldens/Symphonica64_walkthrough.txt" >/tmp/fd.txt 2>/tmp/fd_rand.txt
