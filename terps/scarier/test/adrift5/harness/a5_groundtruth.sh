...
#
# Usage:
#     test/adrift5/harness/a5_groundtruth.sh <game.blorb|game.taf> <script.txt>
#
# Env:
...
#                   FD_RNG=xoshiro test/adrift5/harness/a5_groundtruth.sh <game> <script>
#
...
# cache automatically.
FD_CACHE=${FD_CACHE:-$HERE/test/adrift5/harness/.fd_cache}
