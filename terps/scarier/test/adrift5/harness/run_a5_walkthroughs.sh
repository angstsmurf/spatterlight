...
# game we run test/adrift5/harness/a5_groundtruth.sh in TWO RNG modes and count the diff hunks
...
GT="$HERE/test/adrift5/harness/a5_groundtruth.sh"
GAMES="$HERE/test/adrift5/games"
A5RUN="$HERE/test/adrift5/harness/a5run_dump"
...
# winning transcript (test/adrift5/goldens/BugHuntOnMenelaus_expected.txt, budget 0 = must stay a
...
# test/adrift5/harness/spectre_prayer_solver.py).  Golden = Scarier's winning transcript
...
# test/adrift5/goldens/ReturnToCastleCoris_walkthrough.txt for the four route repairs (start-menu
...
# test/adrift5/notes/TODO_questgiver_divergence.md).
...
# semantics at risk across the entire corpus.  See test/adrift5/goldens/OS_walkthrough.txt.
#
...
# "A hit!" of a multi-blow round.  See test/adrift5/goldens/BeginnersCave_walkthrough.txt.
#
...
# non-openable-container refusal.  See test/adrift5/goldens/BadlandsDemo_walkthrough.txt.
#
...
# on the first pass.  See test/adrift5/goldens/Dementophobia_walkthrough.txt.
#
...
run_one() {  # $1=idx $2=name $3=game $4=vbudget $5=xbudget
    ...
    case "$game" in
        a5probes/*) gf="$HERE/test/adrift5/probes/${game#a5probes/}" ;;
        *)          gf="$GAMES/$game" ;;
    esac
