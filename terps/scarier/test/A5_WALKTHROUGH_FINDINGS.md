...
divergence groups** (ProbeMap's, ProbeRestrictions' and ProbeTaskActions'
have since been FIXED — ProbeTaskActions keeps 1 vanilla RNG-noise hunk —
and ProbePopups shrank from 8 to 4 hunks — see the rows); 11 probes MATCH 0|0
