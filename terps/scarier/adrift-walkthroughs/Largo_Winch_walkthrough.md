...
- **Result:** **WIN**, ending on `Congratulations!`, verified in seeded Scarier
  (`harness/largo_winch_solution.txt`, PASSing golden, win marker
...
The expander that turns the file into `harness/largo_winch_solution.txt` lives
...
323 commands. Ranges are indexes into `harness/largo_winch_solution.txt`.
