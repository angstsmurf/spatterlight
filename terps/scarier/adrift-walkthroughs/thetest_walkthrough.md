...
- **Result:** **WINNABLE — verified 2026-08-01 both in seeded Scarier
  (`harness/thetest_win_solution.txt`, PASSing golden) and LIVE in the genuine
...
- The old 5-point tour (`harness/thetest_solution.txt`) still passes and is
...
## The route (20/25; `harness/thetest_win_solution.txt`)
