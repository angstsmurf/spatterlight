...
static char lowChrs[] = "abcdefghijklmnopqrstuvwxyz������������������������������";

static char uppChrs[] = "ABCDEFGHIJKLMNOPQRSTUVWXYZ������������������������������";
...
/* Input buffers passed to toIso/fromIso are always LISTLEN+1 (defined as 101 in parse.c) */
#define TOISO_BUFSIZE 101
...
0xBE,0xB1,0xD9,0xDA,0xCD,0xCC,0xF7,0xA8,0xB0,0xB7,0xAF,0xAC,0xFE,0xB2,0xB4,0xA0};
  ...
  case 0: /* ISO */
    if (copy != original)
      strlcpy(copy, original, TOISO_BUFSIZE);
    break;
  case 1:			/* Mac */
