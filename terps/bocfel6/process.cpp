...
{
    die("illegal opcode (pc = 0x%lx)", (unsigned long)current_instruction);
}
...
void setup_opcodes()
{
    ...
    setup_single_opcode(6, 6, Opcount::Ext, 0x10, zmove_window); // XXX move_window
    setup_single_opcode(6, 6, Opcount::Ext, 0x11, zwindow_size); // XXX window_size
    setup_single_opcode(6, 6, Opcount::Ext, 0x12, zwindow_style); // XXX window_style
